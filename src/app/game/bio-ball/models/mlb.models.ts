import { CountryBorn, UiPlayer } from './bio-ball.models';
...
export enum MlbHistoricalTeamFullName {
  ...
  LOS_ANGELES_ANGELS_OF_ANAHEIM = 'Los Angeles Angels of Anaheim',
  CLEVELAND_INDIANS = 'Cleveland Indians',
  FLORIDA_MARLINS = 'Florida Marlins',
  MONTREAL_EXPOS = 'Montreal Expos',
  TAMPA_BAY_DEVIL_RAYS = 'Tampa Bay Devil Rays',
}

export enum MlbTeamKey {
  ARIZONA_DIAMONDBACKS = 'arizona-diamondbacks',
  ATHLETICS = 'athletics',
  ATLANTA_BRAVES = 'atlanta-braves',
  BALTIMORE_ORIOLES = 'baltimore-orioles',
